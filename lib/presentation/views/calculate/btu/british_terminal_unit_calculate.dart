            ...
            children: [
              ...
              ContainerInput(
                ...
                input: TextFormField(
                  ...
                  onSaved: (value) => {
                    _bristishTerminalUnitStore.setWidth(double.parse(value!.changeCommaToDot()!))
                  },
              ...
              ContainerInput(
                ...
                input: TextFormField(
                  ...
                  onSaved: (value) => {
                    _bristishTerminalUnitStore.setHeight(double.parse(value!.changeCommaToDot()!))
                  },
                  keyboardType: TextInputType.number,
                  textInputAction: TextInputAction.next,
                  maxLength: 5,
              ...
              ButtonApp(
                  text: LocaleProvider.current.calculate, onPressed: _calculate)
            ],
          ),
        ));
  }
